...
//        addFifthPageInfo();
    ...
    private void createSecondTitle() {
        ...
        for (int indexRow = 0; indexRow < secondOriginSheet.getLastRowNum() + 1; indexRow++) {
            ...
            if (indexRow == 2 || indexRow == 3 || indexRow == 4 || indexRow == 16 || indexRow == 17 || indexRow == 20 || indexRow == 21 || indexRow == 25)
...
//        setSecondTitleValue(secondSheet.getRow(13), 3, String.valueOf(factory.getServiceDao().getAll(5).size()),13);
    ...
    private void setThirdTitleValue(Row row, int numberCell, String cellValue, int rowIndex) {
        Cell cell = row.createCell(numberCell);
        if (rowIndex != 0 && rowIndex != 1 && numberCell == 0 || rowIndex != 0 && rowIndex != 1 && numberCell == 1)
            cell.setCellStyle(setStyleBold(12, false));
        if (rowIndex != 0 && rowIndex != 1 && numberCell == 2 || rowIndex != 0 && rowIndex != 1 && numberCell == 3)
            cell.setCellStyle(setBoldStyleColorBackground(IndexedColors.YELLOW.getIndex(), true));
        ...
        if (rowIndex == 3 && numberCell == 0 || rowIndex == 3 && numberCell == 1 || rowIndex == 19 && numberCell == 0 || rowIndex == 19 && numberCell == 1)
            cell.setCellStyle(setBoldStyleColorBackground(IndexedColors.GREY_40_PERCENT.getIndex(), true));
...
//    }
    ...
    private void setFifthTitleValue(Row row, int numberCell, String cellValue, int rowIndex) {
        ...
        if (rowIndex == 0 && numberCell == 5 || rowIndex == 1 && numberCell == 5 || rowIndex == 1 && numberCell == 7 || rowIndex == 1 && numberCell == 9)
            cell.setCellStyle(setBoldStyleColorBackground(IndexedColors.ORANGE.getIndex(), true));
        ...
        if (rowIndex == 0 && numberCell == 23 || rowIndex == 1 && numberCell == 23 || rowIndex == 1 && numberCell == 24)
            cell.setCellStyle(setBoldStyleColorBackground(IndexedColors.AQUA.getIndex(), true));
